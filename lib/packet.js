...
Packet.prototype.create = function(opts) {
  ...
  var sop1 = (null == opts.sop1) ? FIELDS_HEX.sop1 : opts.sop1,
      sop2 = (null == opts.sop2) ? FIELDS_HEX.sop2 : opts.sop2,
      did  = (null == opts.did)  ? FIELDS_HEX.did : opts.did,
      cid  = (null == opts.cid)  ? FIELDS_HEX.cid : opts.cid,
      seq  = (null == opts.seq)  ? FIELDS_HEX.seq : opts.seq,
      data = (null == opts.data) ? [] : opts.data,
