...
module.exports = function custom(device) {
   ...
   *
   * @param {Object} bitmasks 32bit { mask1, mask2 } (hex)
   ...
   * @return {void}
   */
  device._streamData = function(bitmasks, sps, remove, callback) {
    sps = sps || 4;
    remove = remove || false;
    ...
    mask1 = this._mergeMasks("mask1", bitmasks.mask1, remove);
    mask2 = this._mergeMasks("mask2", bitmasks.mask2, remove);
  ...
  device.streamOdometer = function(sps, remove) {
    ...
    device._streamData({ mask2: 0x0C000000 }, sps, remove, callback);
  };
  ...
  device.streamVelocity = function(sps, remove) {
    ...
    device._streamData({ mask2: 0x01800000 }, sps, remove, callback);
  };
  ...
  device.streamAccelOne = function(sps, remove) {
    ...
    device._streamData({ mask2: 0x02000000 }, sps, remove, callback);
  };
  ...
  device.streamIMUAngles = function(sps, remove) {
    ...
    device._streamData({ mask1: 0x00070000 }, sps, remove, callback);
  };
  ...
  device.streamAccelerometer = function(sps, remove) {
    ...
    device._streamData({ mask1: 0x0000E000 }, sps, remove, callback);
  };
  ...
  device.streamGyroscope = function(sps, remove) {
    var callback = function(data) {
      device.emit("gyroscope", {
        x: data.xGyro,
        y: data.yGyro,
        z: data.zGyro });
    };

    device._streamData({ mask1: 0x00001C00 }, sps, remove, callback);
  };
  ...
  device.streamMotorsBackEmf = function(sps, remove) {
    ...
    device._streamData({ mask1: 0x00000060 }, sps, remove, callback);
  };
};
