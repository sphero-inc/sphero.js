...
module.exports = function custom(device) {
   ...
   *   // sets sphero color to an RGB value
   *   orb.color("#00ff00", function(err, data) {
   *     console.log(err || "Color Changed!");
   *   }
   *   //orb.color(0xff0000, callback);
   *   //orb.color({ red: 0, green: 0, blue: 255 }, callback);
   * });
   *
   * @return {void}
   */
   ...
   *
   * orb.connect(function() {
   *   // sets sphero color to a random value
   *   orb.randomeColor(function(err, data) {
