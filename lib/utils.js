 ...
 * @param {Integer} bytes - Number of bytes to apply Two's complement
 * @return {Integer} negative value
 */
exports.twosToInt = function bufferToInt(value, bytes) {
  var mask = 0x00;
  bytes = bytes || 2;
...
exports.delUndefinedProp = function delUndefinedProp(prop, obj) {
