...
if (ble == null) {
  var err = [
    "It looks like you want to connect to a BB-8 or Ollie",
    "but did not install noble.",
    "To install it run this command:",
    "'npm install noble'",
    "or for more information go to https://github.com/sandeepmistry/noble"
  ].join(" ");
  ...
  if (this.noblePeripheral != null) {
    ...
    ble.on("discover", function(peripheral) {
      if (peripheral.id === self.uuid) {
        ...
        console.log("peripheral with ID " + self.uuid + " found");
