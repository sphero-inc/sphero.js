 ...
 * @publish
 */
Adaptor.prototype.notifyServiceCharacteristic = function(serviceId,
                                                         characteristicId,
                                                         state,
                                                         callback) {
  this.getCharacteristic(serviceId, characteristicId, function(e, c) {
...
Adaptor.prototype._addConnectedService = function(service) {
  this._connectedServices()[service.uuid] = {
    service: service,
    characteristics: {}
  };
};
...
Adaptor.prototype._addConnectedCharacteristic = function(serviceId,
                                                         characteristic) {
  this._connectedCharacteristics(serviceId)[characteristic.uuid] =
    characteristic;
};

Adaptor.prototype._connectedCharacteristic = function(serviceId,
                                                      characteristicId) {
