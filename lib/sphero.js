 ...
 * var spheroRPB = sphero("/dev/rfcomm0", { timeout: 300 });
 * @return {void}
 */
...
/**
 * Stablishes a connection to the sphero, this allows to
 * start sending commands to the sphero.
 * @param {Function} callback to be triggered once connected
 * @example
 * var sphero = require("sphero");
 * // In Windows
 * var spheroRPB = sphero("COM3", { timeout: 300 });
 *
 * spheroRPB.connect(function() {
 *   spheroRPB.color("#00FF00");
 * });
 * @example
 * var sphero = require("sphero");
 * // In OSX
 * var spheroRPB = sphero("/dev/tty.Sphero-BBP-AMP-SPP", { timeout: 300 });
 *
 * spheroRPB.connect(function() {
 *   spheroRPB.color("#00FF00");
 * });
...
/**
 * Ends the connection to the sphero
 * @param {Function} callback to be triggered once connected
 * @example
 * spheroRPB.disconnect(function() {
 *   console.log("Connection to the sphero has ended!");
 * });
 * @return {void}
 */
