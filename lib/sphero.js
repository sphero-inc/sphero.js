...
Sphero.prototype._setCallback = function(seq, callback) {
...
Sphero.prototype._coreCommand = function(commandName, data, callback) {
  var vDevice = VIRTUAL_DEVICES.core,
      seq = this._incSeq(),
      opts = {
  ...
  this._setCallback(seq, callback);
...
Sphero.prototype.setInactivityTimeout = function(time, callback) {
  ...
  var cb = function(err) {
    if (typeof callback === "function") {
      callback(err, {
        device: "core",
        deviceHex: VIRTUAL_DEVICES.core,
