 ...
 * @param {Object} [opts.sop2=0xFD] sop2 to be passed to commands
 * @param {Object} [opts.timeout=500] deadtime between commands, in ms
 * @example
...
/**
 * Establishes a connection to the sphero, this allows to
